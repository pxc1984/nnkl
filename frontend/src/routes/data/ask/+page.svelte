...
<main class="flex min-h-0 flex-1 px-4 pb-6 pt-2 md:px-8 md:pb-8">
    <section class="relative mx-auto flex min-h-0 w-full max-w-5xl flex-1 flex-col pb-52 md:pb-56">
